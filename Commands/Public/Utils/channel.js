...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((command) =>
      command
        .setName("create")
        .setDescription("Create a channel with specified name.")
        .addStringOption((option) =>
          option
            .setName("name")
            .setDescription(`Specified name will be your channel's name.`)
            .setRequired(true)
            .setMinLength(1)
            .setMaxLength(100)
        )
        .addChannelOption((option) =>
          option
            .setName("category")
            .setDescription(
              `Specified category will be your channel's category parent.`
            )
            .setRequired(false)
    ...
    .addSubcommand((command) =>
      command
        ...
        .addChannelOption((option) =>
          option
            .setName("channel")
            .setDescription("Specified channel will be deleted.")
            .setRequired(true)
            .addChannelTypes(
    ...
    .addSubcommand((command) =>
      command
        ...
        .addStringOption((option) =>
          option
            .setName("new-name")
            .setDescription(`Specified name will be your channel's new name.`)
            .setMinLength(1)
            .setMaxLength(100)
            .setRequired(true)
        )
  ...
  async execute(interaction, err) {
    ...
    switch (sub) {
      case "create":
        ...
        if (type === "text") {
          const channel = await interaction.guild.channels
            ...
            .catch((err) => {
              interaction.reply({
                content: `**Couldn't** create your "**${name}**" channel, please make **sure** I have the **Manage Channels** permission!`,
              });
            });
          ...
          const channelembed = new EmbedBuilder()
            ...
            .addFields({
              ...
              value: `> Your channel (${channel}) has been created in \n> the category ${category}!`,
            });
      ...
      case "delete":
        ...
        const channeldelete = await interaction.guild.channels.cache.get(
          channel.id
        );
        ...
        const embed = new EmbedBuilder()
          ...
          .addFields({
            ...
            value: `> Your channel (${channeldelete}) was deleted!`,
          })
          .setTimestamp()
          .setThumbnail(
            "https://cdn.discordapp.com/icons/1078641070180675665/c3ee76cdd52c2bba8492027dfaafa15d.webp?size=1024"
        ...
        await channeldelete.delete().catch((err) => {
          return interaction.reply({
            content: `**Couldn't** delete that channel! Check my **permissions** and try again.`,
          });
        });
      ...
      case "edit":
        ...
        const updatedchannel = await interaction.guild.channels.cache.get(
          newchannel.id
        );
        ...
        const editembed = new EmbedBuilder()
          ...
          .addFields({
            name: `• Channel Edited`,
            value: `> Channel (${updatedchannel}) name changed \n> from "**${oldname}**" => "**${newname}**".`,
          });

        updatedchannel.setName(newname).catch((err) => {
          interaction.reply({
            content: `**Couldn't** edit ${updatedchannel}'s name. Check my **permissions** and try again.`,
          });
        });
